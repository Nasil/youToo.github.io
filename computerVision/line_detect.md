...
- 한점 (a1, b1) 을 기준으로 직선을 반시계 방향으로 돌리면서 r 과 세타(θ) 의 값을 (r1, θ1)을 기록합니다. 그리고 또 다른 한점 (a2, b2) 를 기준으로 같은 방식으로 (r2, θ2)을 기록합니다. 두 지점이 만나는 점이 나오는데 그것이 우리가 찾고자 하는 교차 점이 됩니다. 그 교차점을 이어서 직선을 유추할수가 있습니다.
